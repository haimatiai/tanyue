    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          <Link to="/china" className="block h-full">
            <motion.div
              whileHover={{ scale: 1.02 }}
              className="bg-space-800 border border-red-500/20 rounded-2xl p-8 glow-red cursor-pointer h-full flex flex-col"
            >
          ...
          <Link to="/usa" className="block h-full">
            <motion.div
              whileHover={{ scale: 1.02 }}
              className="bg-space-800 border border-blue-500/20 rounded-2xl p-8 glow-blue cursor-pointer h-full flex flex-col"
            >
              <div className="text-4xl mb-4">🇺🇸</div>
